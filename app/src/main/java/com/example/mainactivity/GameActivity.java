...
public class GameActivity extends AppCompatActivity {
    ...
    private void genererCalcul() {
        ...
        String operation = nombre1 + " " + operateur + " " + nombre2;
        textViewCalcul.setText(operation);
    }
    ...
    private void verifierCalcul(){
        ...
        int calculInt = getTexteCalculEnEntier();
        textViewResultat.setText("");

        if (resultat == calculInt){
            calcul = "";
            score = score + 1;
    ...
    private int getTexteCalculEnEntier() {
        String texteCalcul = textViewCalcul.getText().toString();
        String[] elements = texteCalcul.split(" ");
        ...
        switch (operateur) {
            case "+":
                resultatEntier = nombre1 + nombre2;
                break;
            case "-":
                resultatEntier = nombre1 - nombre2;
                break;
